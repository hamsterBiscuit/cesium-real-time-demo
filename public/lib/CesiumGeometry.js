;(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['CesiumGeometry'] = factory()
  else root['CesiumGeometry'] = factory()
  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var _RectangularSensorScanPlaneFS2 = _interopRequireDefault(
          _RectangularSensorScanPlaneFS
        )
        ...
        RectangularSensorPrimitive.prototype.update = function (frameState) {
          ...
          if (this.showScanPlane) {
            ...
            if (timeDiff == 0) {
              timeDiff = JulianDate.secondsDifference(
                JulianDate.now(),
                this._time
              )
            }
        ...
        function createSectorVertexArray(context, positions) {
          var planeLength =
            Array.prototype.concat.apply([], positions).length -
            positions.length
        ...
        function createCommonShaderProgram(primitive, frameState, material) {
          ...
          var fs = new ShaderSource({
            sources: [
              _RectangularSensor2.default,
              material.shaderSource,
              _RectangularSensorFS2.default,
            ],
          })
        ...
        function createScanPlaneShaderProgram(primitive, frameState, material) {
          ...
          var fs = new ShaderSource({
            sources: [
              _RectangularSensor2.default,
              material.shaderSource,
              _RectangularSensorScanPlaneFS2.default,
            ],
          })
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function ConicArcSensorGeometry(options) {
          ...
          var stackPartitions = Math.round(
            defaultValue(options.stackPartitions, 12)
          )
          var slicePartitions = Math.round(
            defaultValue(options.slicePartitions, 64)
          )
        ...
        ConicArcSensorGeometry.createGeometry = function (conicSensorGeometry) {
          ...
          var numIndices =
            3 * (slicePartitions - 1) +
            6 * (slicePartitions - 1) * (stackPartitions - 2) +
            (slicePartitions - 1) * 1 * 3
          var vertexCount = stackPartitions * slicePartitions
          var indices = IndexDatatype.createTypedArray(vertexCount, numIndices)
          var positions = new Float64Array(
            vertexCount * 3 + (slicePartitions - 1) * 3 * 3
          )
          ...
          if (vertexFormat.position) {
            ...
            for (var i = 0; i < slicePartitions - 1; i++) {
              ...
              positions[positionIndex++] =
                positions[bottomIndex - (slicePartitions - i - 1) * 3]
              positions[positionIndex++] =
                positions[bottomIndex - (slicePartitions - i - 1) * 3 + 1]
              positions[positionIndex++] =
                positions[bottomIndex - (slicePartitions - i - 1) * 3 + 2]

              positions[positionIndex++] =
                positions[bottomIndex - (slicePartitions - i) * 3]
              positions[positionIndex++] =
                positions[bottomIndex - (slicePartitions - i) * 3 + 1]
              positions[positionIndex++] =
                positions[bottomIndex - (slicePartitions - i) * 3 + 2]
            }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function ConicArcSensorOutlineGeometry(options) {
          ...
          var stackPartitions = Math.round(
            defaultValue(options.stackPartitions, 10)
          )
          var slicePartitions = Math.round(
            defaultValue(options.slicePartitions, 8)
          )
        ...
        ConicArcSensorOutlineGeometry.createGeometry = function (
          conicSensorGeometry
        ) {
          var angle = conicSensorGeometry._angle
          var radius = conicSensorGeometry._radius
          ...
          var indicesSize =
            subdivisions * (stackPartitions + slicePartitions - 1)
     ...
     indices[index++] = j;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var defaultValue = Cesium.defaultValue,
          ...
          createMaterialPropertyDescriptor =
            Cesium.createMaterialPropertyDescriptor,
        ...
        ConicArcSensorGraphics.prototype.merge = function (source) {
          ...
          this.outlineColor = defaultValue(
            this.outlineColor,
            source.outlineColor
          )
          this.outlineWidth = defaultValue(
            this.outlineWidth,
            source.outlineWidth
          )
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        //conicSensor
        Cesium.RectangularSensorPrimitive =
          _RectangularSensorPrimitive.RectangularSensorPrimitive
        Cesium.RectangularSensorGraphics =
          _RectangularSensorGraphics.RectangularSensorGraphics
        Cesium.RectangularSensorVisualizer =
          _RectangularSensorVisualizer.RectangularSensorVisualizer

        //conicSensor
        Cesium.ConicArcSensorGeometry =
          _ConicArcSensorGeometry.ConicArcSensorGeometry
        Cesium.ConicArcSensorOutlineGeometry =
          _ConicArcSensorOutlineGeometry.ConicArcSensorOutlineGeometry
        Cesium.ConicArcSensorGraphics =
          _ConicArcSensorGraphics.ConicArcSensorGraphics
        Cesium.ConicArcSensorCollection =
          _ConicArcSensorCollection.ConicArcSensorCollection
        ...
        DataSourceDisplay.defaultVisualizersCallback = function (
          ...
          return array.concat([
            new _RectangularSensorVisualizer.RectangularSensorVisualizer(
              scene,
              entities
            ),
          ])
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var createMaterialPropertyDescriptor =
          Cesium.createMaterialPropertyDescriptor
        ...
        defineProperties(RectangularSensorGraphics.prototype, {
          ...
          showThroughEllipsoid: createPropertyDescriptor(
            'showThroughEllipsoid'
          ),
        ...
        RectangularSensorGraphics.prototype.merge = function (source) {
          ...
          this.showDomeLines = defaultValue(
            this.showDomeLines,
          ...
          this.gaze = defaultValue(this.gaze, source.gaze)
          this.showScanPlane = defaultValue(
            this.showScanPlane,
          ...
          this.scanPlaneMode = defaultValue(
            this.scanPlaneMode,
            source.scanPlaneMode
          )
          this.scanPlaneRate = defaultValue(
            this.scanPlaneRate,
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var RectangularSensorVisualizer = function RectangularSensorVisualizer(
          scene,
          entityCollection
        ) {
          // >>includeStart('debug', pragmas.debug);
        ...
        RectangularSensorVisualizer.prototype.update = function (time) {
          ...
          for (var i = 0, len = entities.length; i < len; i++) {
            ...
            if (show) {
              ...
              show =
                defined(position) && defined(xHalfAngle) && defined(yHalfAngle)
            }
            ...
            if (!defined(primitive)) {
              primitive =
                new _RectangularSensorPrimitive.RectangularSensorPrimitive()
              primitive.id = entity
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var DeveloperError = Cesium.DeveloperError
        var ColorGeometryInstanceAttribute =
        ...
        var DistanceDisplayConditionGeometryInstanceAttribute =
          Cesium.DistanceDisplayConditionGeometryInstanceAttribute
        ...
        ConicArcSensorCollection.prototype.update = function () {
          ...
          for (var i = 0, len = conicArcSensorCollection.length; i < len; i++) {
            ...
            if (!defined(geometry)) {
              ...
              entity._geometry =
                _ConicArcSensorGeometry.ConicArcSensorGeometry.createGeometry(
                  conic
                )
            ...
            if (outline) {
              ...
              if (!defined(outlineGeometry)) {
                var conicOutline
                conicOutline =
                  new _ConicArcSensorOutlineGeometry.ConicArcSensorOutlineGeometry(
                    {
                ...
                entity._outlineGeometry =
                  _ConicArcSensorOutlineGeometry.ConicArcSensorOutlineGeometry.createGeometry(
                    conicOutline
                  )
          ...
          if (instances.length > 0) {
            this._primitive = this._primitives.add(
              new Primitive({
                asynchronous: false,
          ...
          if (outlineInstances.length > 0) {
            this._outlinePrimitive = this._primitives.add(
              new Primitive({
                asynchronous: false,
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function ConicArcSensor(options) {
          ...
          if (
            !(
              conicArcSensor instanceof
              _ConicArcSensorGraphics.ConicArcSensorGraphics
            )
          ) {
            conicArcSensor = new _ConicArcSensorGraphics.ConicArcSensorGraphics(
              conicArcSensor
            )
          }
